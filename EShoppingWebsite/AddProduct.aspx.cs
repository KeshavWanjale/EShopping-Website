...
namespace EShoppingWebsite
{
    ...
    {
        public static String configString = ConfigurationManager.ConnectionStrings["EShoppingDB"].ConnectionString;
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                BindCategory();
                BindGender();
                // cannot use drop down list till catagory is selected
                ddlSubCategory.Enabled = false;
                // to generaate correct size admin should select all brand ,category, sub category  and gender
                ddlGender.Enabled = false;//to be enabeled when subcat index change event
        ...
        protected void ddlCategory_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                // after selecting category we can choose sub category
        ...
        //For Size CheckBox list using gender drop dlist
        ...
        {
            // now admin can select correct size
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            using (SqlConnection con = new SqlConnection(configString))
            {
                ...
                {
                    //if size is selected then you can add to size qunatity table
